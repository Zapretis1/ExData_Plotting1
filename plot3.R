...
## 
## This R script called plot3.R does the following:
## 1) Download the data into a custom folder
## 2) Load the relevant data into R
## 3) Create a graphic plot3.png similar to the target Plot 3
## 
## Plot 3 is time series representing the values of 3 energy submeters
...
plot_name <- "plot3.png" #name of the plot
...
with(epc_zapretis1, {
    ...
    lines(Measures, Sub_metering_2, col = "red") # plot sub_metering_2 in same window
    
    lines(Measures, Sub_metering_3, col = "blue") # plot sub_metering_3 in same window
